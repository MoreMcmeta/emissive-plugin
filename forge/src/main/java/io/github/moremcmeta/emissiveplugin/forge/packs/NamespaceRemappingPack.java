...
public class NamespaceRemappingPack implements PackResources {
    ...
    public InputStream getResource(PackType packType, ResourceLocation location) throws IOException {
        ...
        Optional<Resource> resource = RESOURCE_MANAGER.getResource(fullPath);
    ...
    @Override
    public Collection<ResourceLocation> getResources(PackType packType, String namespace, String pathStart, Predicate<ResourceLocation> predicate) {
