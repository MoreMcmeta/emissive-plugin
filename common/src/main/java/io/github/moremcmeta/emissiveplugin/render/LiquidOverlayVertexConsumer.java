...
public final class LiquidOverlayVertexConsumer implements VertexConsumer {
    ...
    public LiquidOverlayVertexConsumer(SpriteFinder spriteFinder, VertexConsumer delegate) {
    ...
    public VertexConsumer addVertex(float x, float y, float z) {
        ...
        if (currentVertex < VERTS_PER_QUAD) {
            TASKS[currentVertex].add((delegate, texU, texV, lightU, lightV, red, green, blue) -> delegate.addVertex(x, y, z));
            return this;
        }
    ...
    public VertexConsumer setColor(int red, int green, int blue, int alpha) {
        TASKS[currentVertex].add((delegate, texU, texV, lightU, lightV, r, g, b) -> delegate.setColor(r, g, b, alpha));
    ...
    public VertexConsumer setUv(float u, float v) {
        TASKS[currentVertex].add((delegate, texU, texV, lightU, lightV, red, green, blue) -> delegate.setUv(texU, texV));
    ...
    public VertexConsumer setUv1(int u, int v) {
        TASKS[currentVertex].add((delegate, texU, texV, lightU, lightV, red, green, blue) -> delegate.setUv1(u, v));
        return this;
    }

    @Override
    public VertexConsumer setUv2(int u, int v) {
        TASKS[currentVertex].add((delegate, texU, texV, lightU, lightV, red, green, blue) -> delegate.setUv2(lightU, lightV));
    ...
    public VertexConsumer setNormal(float x, float y, float z) {
        TASKS[currentVertex].add((delegate, texU, texV, lightU, lightV, red, green, blue) -> delegate.setNormal(x, y ,z));
        return this;
    }
